                ...
                <div className='home-header-container'>
                    <div className='home-header-content'>
                        ...
                        <div className='center-content'>
                            ...
                            <div className='child-content'>
                                <div><b><FormattedMessage id="homeheader.healty-facility" /></b></div>
                    ...
                    <div className='home-header-banner'>
                        ...
                        <div className='content-down'>
                            <div className='options'>
                                ...
                                <div className='option-child'>
                                    <div className='icon-child'><i className="fas fa-hands"></i></div>
                                    <div className='text-child'><FormattedMessage id="banner.child3" /></div>
                                </div>
                                <div className='option-child'>
                                    <div className='icon-child'><i className="fas fa-image"></i></div>
                                    <div className='text-child'><FormattedMessage id="banner.child4" /></div>
                                </div>
                                <div className='option-child'>
                                    <div className='icon-child'><i className="fab fa-accessible-icon"></i></div>
                                    <div className='text-child'><FormattedMessage id="banner.child5" /></div>
                                </div>
                                <div className='option-child'>
                                    <div className='icon-child'><i className="fab fa-slideshare"></i></div>
